...
import FilmDescription from "./component/FilmDescription";
...
function  App  () {
 const [Films, setFilms] = useState([
    ...
    PosterUrl:'https://nicholassparks.com/wp-content/uploads/2014/07/BOMPoster-680x972.jpg' ,
     Date : '2014',
     Rate :'4' ,
     Trailer:'https://www.youtube.com/watch?v=mrEvBiqoeRc'
    },
    {
      id:Math.random(),
      Title: 'Safe heaven',
     ...
     Date :'2013',
     Rate :'4' ,
      Trailer:'https://www.youtube.com/watch?v=ejQEdUwv0ew'
    },
     {
      id:Math.random(),
